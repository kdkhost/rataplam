    ...
    <footer className="bg-gray-900 text-gray-400 mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-3 mb-5">
              <div className="w-10 h-10 bg-gradient-to-br from-rose-500 to-violet-500 rounded-xl flex items-center justify-center shadow-lg shadow-rose-500/25">
                <span className="text-white font-black text-lg">R</span>
              </div>
              <div>
                <span className="text-xl font-black text-white tracking-tight">RATAPLAM</span>
                <p className="text-[11px] text-gray-500 -mt-0.5">roupas que ele ama usar</p>
              </div>
            </div>
            <p className="text-sm leading-relaxed text-gray-500">Roupas infantis modernas com qualidade, conforto e estilo para o seu pequeno. Macacoes, bermudas, blusas e muito mais.</p>
            <div className="flex gap-3 mt-5">
              <a href="https://www.instagram.com/rataplam.loja/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-gradient-to-br hover:from-rose-500 hover:to-violet-500 transition-all duration-300 group">
              ...
              <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-green-600 transition-all duration-300 group">
            ...
            <div className="mt-6 pt-5 border-t border-gray-800">
              ...
              <ul className="space-y-2.5 text-sm">
                <li className="flex items-center gap-2.5">
                  <svg className="w-4 h-4 text-rose-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-5">
          <p className="text-sm">&copy; {new Date().getFullYear()} RATAPLAM. Todos os direitos reservados.</p>
