        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <div className="flex gap-3 mt-5">
              ...
              <a href="https://wa.me/5521996913143" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-green-600 transition-all duration-300 group">
