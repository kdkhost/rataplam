...
const products = [
  {
    id: 1,
    name: 'Macacao Cachorro',
    price: 89.90,
    image: 'https://static.wixstatic.com/media/e23129_e7615472cc5d4c2b8eae2d876d360ea3~mv2.jpg',
  },
  {
    id: 2,
    name: 'Macacao Nemo',
    price: 99.90,
    image: 'https://static.wixstatic.com/media/e23129_b887b8b44bd743749d0eeb3740846160~mv2.png',
  },
  {
    id: 3,
    name: 'Macacao Selva',
    price: 94.90,
    image: 'https://static.wixstatic.com/media/e23129_74b957d328f247a7b23710257ada6d72~mv2.jpg',
  },
  {
    id: 4,
    name: 'Vestido Delicate',
    price: 119.90,
    image: 'https://static.wixstatic.com/media/e23129_9f4c1c93c54d4137b82477ff0e685358~mv2.png',
  },
  {
    id: 5,
    name: 'Bermuda Tropical',
    price: 69.90,
    image: 'https://static.wixstatic.com/media/e23129_41db3354d3834c6ab8815821e5817913~mv2.jpg',
  },
  {
    id: 6,
    name: 'Blusa Friends Trip',
    price: 59.90,
    image: 'https://static.wixstatic.com/media/e23129_c8f4906b9df04133a3121e86e1753485~mv2.png',
  },
  {
    id: 7,
    name: 'Biquini Liana',
    price: 79.90,
    image: 'https://static.wixstatic.com/media/e23129_8165b0bff17049beb94aa0d3359b9bbd~mv2.png',
  },
  {
    id: 8,
    name: 'Sapatinho Trico',
    price: 49.90,
    image: 'https://static.wixstatic.com/media/e23129_4659ca570c404bb2b4d3831ff9dfd4b7~mv2.jpg',
  },
];
...
const ageRanges = [
  { label: '0-1', slug: '0-a-1', emoji: '👶', color: 'from-rose-200 to-pink-200' },
  { label: '1-3', slug: '1-a-3', emoji: '🧸', color: 'from-pink-200 to-purple-200' },
  { label: '4-8', slug: '4-a-8', emoji: '🌟', color: 'from-purple-200 to-violet-200' },
  { label: '10-14', slug: '10-a-14', emoji: '🚀', color: 'from-violet-200 to-fuchsia-200' },
];
...
const trustItems = [
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0H21M3.375 14.25h-.375a3 3 0 01-3-3V7.5a3 3 0 013-3h.375m0 0h16.5m-16.5 0a3 3 0 00-3 3v3.75a3 3 0 003 3h.375m16.5 0h.375a3 3 0 003-3V7.5a3 3 0 00-3-3h-.375m0 0V4.125a2.25 2.25 0 00-2.25-2.25H10.5m0 0h3m-3 0V1.5a2.25 2.25 0 00-2.25-2.25H5.625a2.25 2.25 0 00-2.25 2.25V4.125" />
      </svg>
    ),
    title: 'Frete Gratis',
    description: 'Acima de R$ 199,00 para todo o Brasil',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: 'Criptografia e protecao de dados',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: 'Troca Facil',
    description: '30 dias para trocar sem complicacao',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: 'Peca a peca, pensando no bem-estar infantil',
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              Encontre a peca perfeita para o seu pequeno
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
            {categories.map((cat) => (
              <Link
                ...
                className="group relative overflow-hidden rounded-2xl aspect-square shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1"
              >
                <Image
                  src={cat.image}
                  alt={cat.name}
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-rose-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              As pecas mais amadas pelas criancas e pais
            </p>
          </div>
            ...
            {products.map((product) => (
              ...
              >
                <div className="relative aspect-square overflow-hidden bg-gray-50">
                  ...
                  <button className="absolute bottom-3 right-3 w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0 hover:bg-pink-500 hover:text-white text-pink-500">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-5.98.572m5.98-.572h9m-9 0a3 3 0 01-5.98.572M17.25 14.25a3 3 0 005.98.572m-5.98-.572h-9m9 0a3 3 0 015.98.572M3.75 6.75h16.5l-1.5 9H5.25l-1.5-9z" />
                    </svg>
                  </button>
                </div>
                <div className="p-4">
                  <h3 className="font-bold text-gray-900 text-sm sm:text-base mb-1 truncate">{product.name}</h3>
                  ...
                  <button className="w-full py-2.5 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-xl font-semibold text-sm hover:from-pink-600 hover:to-rose-600 transition-all shadow-md shadow-pink-200 hover:shadow-lg active:scale-95">
          ...
          <div className="text-center mt-12">
            <Link
              href="/loja"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-pink-500 to-violet-500 text-white rounded-full font-bold text-lg hover:from-pink-600 hover:to-violet-600 transition-all shadow-lg shadow-pink-200 hover:shadow-xl hover:scale-105"
            >
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              Filtrar por faixa etaria para encontrar o tamanho ideal
            </p>
          </div>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
              <div className="flex-1 text-center lg:text-left">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 bg-white text-purple-600 rounded-full font-bold text-lg hover:bg-purple-50 transition-all shadow-2xl shadow-purple-900/30 hover:scale-105"
                >
                  Experimentar Agora
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-white to-rose-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              A satisfacao das familias e a nossa maior motivacao
            </p>
          </div>
            ...
            {testimonials.map((t, i) => (
              <div key={i} className="bg-white rounded-2xl p-8 shadow-md border border-gray-100 hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-400 to-violet-400 flex items-center justify-center text-white font-bold text-sm">
                    {t.name.charAt(0)}
                  </div>
                  <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {trustItems.map((item, i) => (
              <div key={i} className="text-center p-6 rounded-2xl bg-rose-50/50 border border-rose-100 hover:bg-rose-50 transition-colors duration-300">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-500 text-white mb-4 shadow-lg shadow-pink-200">
                  {item.icon}
                </div>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-6 py-4 rounded-full text-gray-900 font-medium placeholder:text-gray-400 focus:outline-none focus:ring-4 focus:ring-white/30"
            />
            <button
              type="submit"
              className="px-8 py-4 bg-white text-pink-600 rounded-full font-bold hover:bg-rose-50 transition-all shadow-2xl shadow-pink-900/30 hover:scale-105 whitespace-nowrap"
            >
              Cadastrar
            </button>
          </form>
