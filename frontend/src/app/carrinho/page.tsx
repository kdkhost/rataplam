  ...
  if (itens.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-24 text-center">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-3">Seu carrinho esta vazio</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-4">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-1.5">
                      {item.tamanho && (
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600">Tam: {item.tamanho}</span>
                      )}
                      {item.cor && (
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600">Cor: {item.cor}</span>
                      )}
                    </div>
                  </div>
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <Link href="/loja" className="text-sm text-rose-500 hover:text-rose-600 font-medium transition-colors flex items-center gap-1.5">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-gray-100 space-y-2">
                ...
                <div className="flex justify-between pt-2 border-t border-gray-100">
                  ...
                  <span className="font-bold text-2xl bg-gradient-to-r from-rose-500 to-violet-500 bg-clip-text text-transparent">{formatarMoeda(total + frete - desconto)}</span>
                </div>
              </div>
            </div>
            <Link href="/checkout" className="block w-full mt-6 py-4 bg-gradient-to-r from-rose-500 to-violet-500 text-white rounded-2xl font-bold text-center hover:shadow-lg hover:shadow-rose-500/25 transition-all duration-300 hover:-translate-y-0.5">
              Finalizar Compra
            </Link>
